      ...
      <section className="mx-auto max-w-7xl px-6 py-10">
        <div className="mb-8">
          ...
          <p className="mt-2 max-w-4xl text-lg leading-relaxed text-gray-600">
            Year 2 Dance develops children&apos;s ability to move in time to music, copy and recall motifs, link movements into short sequences and use choreographic devices while developing confidence, control and self-expression.
          </p>
        </div>
          ...
          <div className="grid gap-8 p-6 md:grid-cols-3 md:p-8">
            <div>
              ...
              <ul className="space-y-3 text-lg leading-relaxed text-gray-700">
                <li>• Demonstrate moving in time to the beat of the music.</li>
                <li>• Demonstrate copying and recalling a simple movement motif.</li>
                <li>• To start to link movements together to create a short dance sequence.</li>
                <li>• To start to use simple choreographic devices, such as levels, direction and pathways.</li>
                <li>• To start to learn different dance steps and recognise which dance styles they are from.</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-lg leading-relaxed text-gray-700">
                <li>• To start to develop balance and control when moving the body to a beat or music.</li>
                <li>• To start to develop muscular strength to holding different body shapes and moving between them.</li>
                <li>• To start to develop cardio vascular endurance by moving continuously to a beat or music.</li>
                <li>• To start to develop gross motor skill, co ordination and control when learning and performing dance steps and motifs.</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-lg leading-relaxed text-gray-700">
                ...
                <li>• Demonstrate build confidence when moving to music.</li>
                <li>• To start to develop self expression.</li>
              </ul>
            </div>
          </div>
        </div>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            <div className="rounded-2xl border bg-white p-6 shadow-sm">
              ...
              <ul className="space-y-2 text-lg leading-relaxed text-gray-700">
                <li>• Basic Salsa Step Forward/Back</li>
                <li>• Basic Side Step</li>
                <li>• Right Turn / Left Turn</li>
                <li>• Suzy Q</li>
                <li>• Cumbia Step</li>
                <li>• Hip movements</li>
              </ul>
            ...
            <div className="rounded-2xl border bg-white p-6 shadow-sm">
              ...
              <ul className="space-y-2 text-lg leading-relaxed text-gray-700">
                ...
                <li>• Dandiya Step</li>
                <li>• Ghoomar Turn</li>
                <li>• Shoulder Bounces</li>
                <li>• Hand waves</li>
                <li>• Side-to-Side step</li>
              </ul>
            </div>
        ...
        <div>
          ...
          <p className="mb-6 text-lg text-gray-600">
            Select a lesson below to view the complete Year 2 Dance lesson plan.
          </p>
