...
const lessons = [
  {
    number: 1,
    title:
      "Treasure Island With Defenders, 2v1 Attacking & Defending & Zone Ball",
    href: "/curriculum/ks2/year-4/football/lesson-1",
  },
  {
    number: 2,
    title: "Dribble Change, Channel Attack & Zone Ball",
    href: "/curriculum/ks2/year-4/football/lesson-2",
  },
  {
    number: 3,
    title:
      "Dribble Knockout, Treasure Island With Defenders & First To Score",
    href: "/curriculum/ks2/year-4/football/lesson-3",
  },
  {
    number: 4,
    title:
      "Player Shadow, 2v1 Attacking & Defending & World Cup Three's",
    href: "/curriculum/ks2/year-4/football/lesson-4",
  },
  {
    number: 5,
    title: "Pass and Move, Gate Passing & 4 Corner Football",
    href: "/curriculum/ks2/year-4/football/lesson-5",
  },
  {
    number: 6,
    title: "Quick Fire Goals & 5-a-side Football Tournament",
    href: "/curriculum/ks2/year-4/football/lesson-6",
  },
];

export default function Year4FootballPage() {
  return (
      ...
      <section className="mx-auto max-w-7xl px-6 py-10">
        <div className="mb-8">
          ...
          <p className="mt-2 max-w-4xl text-lg leading-relaxed text-gray-600">
            Developing greater control when dribbling, passing and receiving,
            attacking and defending, accurate shooting, shielding and tactical
            understanding within 5-a-side football.
          </p>
        </div>
          ...
          <div className="grid gap-8 p-6 md:grid-cols-3 md:p-8">
            <div>
              ...
              <ul className="space-y-3 text-lg leading-relaxed text-gray-700">
                ...
                <li>
                  • Apply and demonstrate dribbling with close control when
                  defenders are present.
                </li>
                <li>
                  • Apply and demonstrate accurate passing and receiving of the
                  football within a game.
                </li>
                <li>
                  • Apply and demonstrate jockeying when defending, timing a
                  challenge and closing down space.
                </li>
                <li>
                  • Apply and demonstrate accurate shooting using both placement
                  and power.
                </li>
                <li>
                  • Start to utilise the body when defending and shielding the
                  ball.
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-lg leading-relaxed text-gray-700">
                <li>
                  • Apply and demonstrate understanding of the rules of
                  football.
                </li>
                <li>
                  • Apply and demonstrate understanding of attacking,
                  midfield, defending and goalkeeper roles.
                </li>
                <li>
                  • Apply and demonstrate understanding of a basic diamond
                  formation in 5-a-side football.
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-lg leading-relaxed text-gray-700">
                <li>
                  • Apply and demonstrate communicating with team mates when
                  passing, receiving and defending.
                </li>
                <li>
                  • Demonstrate working as part of a team, supporting others and
                  showing respect for team mates and opponents.
                </li>
                <li>
                  • Apply and demonstrate evaluating own performance and giving
                  feedback to others.
                </li>
                <li>
                  • Apply and demonstrate praise and motivational language
                  towards team mates.
                </li>
              </ul>
            </div>
        ...
        <div className="mb-10 grid gap-6 lg:grid-cols-2">
          <div className="rounded-2xl border bg-green-50 p-7 shadow-sm">
            ...
            <ol className="list-decimal space-y-4 pl-6 text-lg leading-relaxed text-gray-800">
              <li>
                Continue to develop ball control while encouraging children to
                move at pace and change direction with the ball.
              </li>
              <li>
                Encourage players to spread out, move into space and create
                passing options for the player in possession.
              </li>
              <li>
                Develop jockeying and decision making so children understand
                when to delay an attacker and when to attempt a tackle.
              </li>
              <li>
                Encourage positive communication between team mates when
        ...
        <div>
          ...
          <p className="mb-6 text-lg text-gray-600">
            Select a lesson below to view the complete Year 4 Football lesson
            plan.
          </p>
