...
const lessons = [
  {
    number: 1,
    title: "Player Shadow, Channel Attack & World Cup Three's",
    href: "/curriculum/ks2/year-5/football/lesson-1",
  },
  {
    number: 2,
    title:
      "Dribble Knockout, 2v2 Attacking & Defending & 4 Corner Football",
    href: "/curriculum/ks2/year-5/football/lesson-2",
  },
  {
    number: 3,
    title: "Protect The Gates, Channel Attack & End Ball/Zone Ball",
    href: "/curriculum/ks2/year-5/football/lesson-3",
  },
  {
    number: 4,
    title: "Quick Fire Goals, Three Finish Challenge & First To Score",
    href: "/curriculum/ks2/year-5/football/lesson-4",
  },
  {
    number: 5,
    title: "Passing Gates, Break the Lines & Conditioned Game",
    href: "/curriculum/ks2/year-5/football/lesson-5",
  },
  {
    number: 6,
    title: "Dribble Knockout & 7-a-side Football Tournament",
    href: "/curriculum/ks2/year-5/football/lesson-6",
  },
];

export default function Year5FootballPage() {
  return (
      ...
      <section className="mx-auto max-w-7xl px-6 py-10">
        <div className="mb-8">
          ...
          <p className="mt-2 max-w-4xl text-lg leading-relaxed text-gray-600">
            Developing close control at speed, accurate long and short passing,
            advanced attacking and defending skills, shooting, tactical
            awareness, formations and set-play understanding within 7-a-side
            football.
          </p>
        </div>
          ...
          <div className="grid gap-8 p-6 md:grid-cols-3 md:p-8">
            <div>
              ...
              <ul className="space-y-3 text-lg leading-relaxed text-gray-700">
                <li>
                  • Apply, Demonstrate and Self-Evaluate changing direction at
                  speed when dribbling to move the ball towards goal.
                </li>
                <li>
                  • Apply and Demonstrate dribbling with close control at speed,
                  both with and without defenders in play.
                </li>
                <li>
                  • Apply, Demonstrate and Self-Evaluate frequent, accurate
                  passing and receiving of the football.
                </li>
                <li>
                  • Apply, Demonstrate and Self-Evaluate jockeying when
                  defending, timing a challenge and closing down space quickly.
                </li>
                <li>
                  • Start to understand and apply the correct decision of which
                  tackling technique to implement in any given scenario.
                </li>
                <li>
                  • Apply and Demonstrate accurate shooting in a game applying
                  the correct technique for both placement and power.
                </li>
                <li>
                  • Apply and Demonstrate utilising the body when defending, or
            ...
            <div>
              ...
              <ul className="space-y-3 text-lg leading-relaxed text-gray-700">
                <li>
                  • Apply, Demonstrate and Self-Evaluate understanding the rules
                  of a football game.
                </li>
                <li>
                  • Apply and Demonstrate an understanding of roles and
                  responsibilities of attackers, midfielders, defenders and
                  goalkeepers in a game scenario.
                </li>
                <li>
                  • Start to understand different football formations and
                  justify tactical choices by assigning position-specific roles
                  and responsibilities to team mates.
                </li>
                <li>
                  • Start to understand the relevance of differing set-piece
                  scenarios such as corners and free kicks.
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-lg leading-relaxed text-gray-700">
                <li>
                  • Apply, Demonstrate and Self-Evaluate communicating to team
                  mates when passing, receiving and defending.
                </li>
                <li>
                  • Apply and Demonstrate working as part of a team and
                  supporting others, showing respect for team mates and
                  opponents - learning to win and lose positively.
                </li>
                <li>
                  • Apply and Demonstrate evaluating own and peers&apos;
                  performance, reflecting on self and others, giving and
                  receiving feedback.
                </li>
                <li>
                  • Apply and Demonstrate how to encourage a team mate using
                  praise and motivational language.
                </li>
              </ul>
            </div>
          </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  ...
                  This only applies when the ball leaves the pitch, not if the
                  goalkeeper collects with their hands.
                </li>
                <li>
        ...
        <div className="mb-10 grid gap-6 lg:grid-cols-2">
          <div className="rounded-2xl border bg-green-50 p-7 shadow-sm">
            ...
            <ol className="list-decimal space-y-4 pl-6 text-lg leading-relaxed text-gray-800">
              <li>
                Ball control is still the most important skill. Expect children
                to maintain close control at speed and whilst changing
                direction to create space or evade defenders.
              </li>
              <li>
                Encourage children to spread out and discover varying passing
                techniques in order to make both long and short passes
                accurately.
              </li>
              <li>
                Develop defending from jockeying and tackling to include
                shadowing, jockeying, tackling and shielding.
              </li>
              <li>
                Focus on peer-to-peer constructive feedback. Children should
                develop an understanding of game play and ideas that can help
                their team.
              </li>
            </ol>
          </div>
        ...
        <div>
          ...
          <p className="mb-6 text-lg text-gray-600">
            Select a lesson below to view the complete Year 5 Football lesson
            plan.
          </p>
